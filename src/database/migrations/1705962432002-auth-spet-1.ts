...
export class AuthSpet11705962432002 implements MigrationInterface {
    name = 'AuthSpet11705962432002'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "email" character varying(75) NOT NULL`);
